...
**Priority 1 — 业务上下文**
- 竞品分析/市场调研任务 ≥ 3 家竞品 → 加载
- 运营决策/策略规划含"为什么"类深层问题 → 加载
- 旅游产品/路线设计需拆解关键因素 → 加载

**Priority 2 — 任务类型**
- 含"降秩/找秩/拆解底层/找骨架/核心驱动因素"→ 加载
- 含"这个领域靠什么撑着/背后的逻辑是什么/底层是什么"→ 加载
- 含"domain decompose / find rank / irreducible generators"→ 加载
...
### 手动触发关键词
降秩、找秩、秩是什么、这个领域靠什么撑着、背后是什么、拆解底层、domain decompose、find rank、底层逻辑、核心驱动因素、找骨架、这个市场真正的驱动因素是什么、竞争的本质是什么
